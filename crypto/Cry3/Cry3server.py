...
hint = 'Cryptography is typically bypassed, not penetrated.'
flag = b'D0g3{New_3ra_@f_P.K_Crypt0graphy_1976}'
key = os.urandom(16)
...
def encrypt(message):
    ...
    return binascii.hexlify(aes.encrypt(message)[-16:])  # bytes


Authentication = encrypt(b'Whitfield__Diffie')  # bytes
